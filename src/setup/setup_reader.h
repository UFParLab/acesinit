...
public:
    ...
    // Added by Dr. Sanders
	typedef std::map<std::string, array::Block*> NamePredefinedContiguousArrayMap;
    typedef std::map<std::string, array::Block*>::iterator NamePredefinedContiguousArrayMapIterator;
