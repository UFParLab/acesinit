...
//		virtual int * read_int_array(int * size){return nullptr;}
//		virtual double * read_double_array(int *size){return nullptr;}
//		virtual double * read_double_array_siox(int *size){return nullptr;};
//		virtual size_t read_size_t(){return 0;}
//		virtual std::string * read_string_array(int * size){return nullptr;}
//	};
