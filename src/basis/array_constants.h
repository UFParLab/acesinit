...
namespace array{
extern int unused_index_slot;
extern int unused_index_value;
extern int unused_index_segment_size;
extern int wild_card_index;
...
enum ArrayType_t {
    ...
    static_array_t = (attr_contiguous | attr_auto_allocate | attr_predefined | attr_persistent),  //==108  //TODO CHECK auto_allocate??
