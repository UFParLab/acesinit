 ...
 *
 * Adding rank to shape.  Have not changed anything not in this class
 *
 *
 * */
...
//	explicit BlockShape(const segment_size_array_t&);
	BlockShape(const array::segment_size_array_t&, int rank);
	~BlockShape();
...
//todo  this should be private
	int rank_;
  array::segment_size_array_t segment_sizes_;
